...
**1. Mã hóa Base64 là gì?** Là kỹ thuật chuyển đổi dữ liệu nhị phân (binary) hoặc văn bản thành một chuỗi ký tự chỉ bao gồm 64 ký tự an toàn trong bản mã ASCII (bao gồm: A-Z, a-z, 0-9, dấu +,/, và dùng dấu = để làm ký tự đệm/padding ở cuối).  
**2. Mục đích sử dụng**  
...
**3. Cú pháp và cách dùng phổ biến**  
`Mã hóa (Encode)`  
